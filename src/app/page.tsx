  ...
  return (
    <div className="flex min-h-screen pt-32">
      <main className="flex flex-col gap-1 row-start-2 items-center justify-items-center text-center w-full">
        ...
        <Heading />
        <p
          className="max-w-[800px] mx-auto text-[1.1rem] leading-[1.5] text-center"
        >
        ...
        <div className="flex gap-4 justify-center mt-3">
          ...
          <Link
            className="inline-block bg-gradient-to-r from-[#F4F4F4] to-[#FFFFFF] text-black py-2.5 px-4 rounded-md font-medium text-[0.9rem] border border-[#E6E6E6] relative"
            href="/login"
          >
            Contact Us
        ...
        <div className="columns-1 text-center mt-20">
          <Image
            ...
            width={800}
            height={400}
            className="text-transparent h-[400px] object-cover object-top w-[800px] absolute bottom-0 left-1/2 transform -translate-x-1/2"
          />
        </div>
      </main>
    </div>
